...
$field['options']['display_by'] = isset($field['options']['display_by']) ? $field['options']['display_by'] : 'name';
$field['options']['value_by'] = isset($field['options']['value_by']) ? $field['options']['value_by'] : 'id';
$options = \DB::table($field['options']['table'])
    ->pluck($field['options']['display_by'], $field['options']['value_by'])
    ->toArray();
@endphp
<!-- select from array -->
